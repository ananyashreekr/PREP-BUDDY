...
const page = () => {
  return (
    ...
    //   <h1 className='red font-bold text-[22px]'>Welcome to PREP BUDDY</h1>
    ...
    <div>
      ...
      <main className="min-h-screen">
        ...
        <header className="w-full py-8 bg-gray-100 shadow-md">
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-6">
            <h1 className="text-3xl font-bold text-primary">PREP BUDDY </h1>
            <nav className="flex flex-col sm:flex-row flex-wrap items-center justify-between mt-4 md:mt-0 space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              <div>
                <a
                  ...
                  href="https://github.com/ananyashreekr/PREP-BUDDY.git">
            ...
            <div className="flex flex-wrap justify-center mt-8">
              <div className="w-full md:w-1/3 px-4 py-8">
                <div className="bg-blue-100 rounded-lg p-6 shadow-md">
                  <h3 className="text-2xl font-semibold text-black-600">PREP BUDDY</h3>
            ...
            <div className="flex flex-wrap justify-center mt-8">
              <div className="w-full md:w-1/2 px-4 py-8">
                <div className="bg-white rounded-lg p-6 shadow-md">
                  ...
                  <h4 className="mt-4 text-lg font-semibold text-blue-600">- Anantesh G</h4>
                </div>
              </div>
              <div className="w-full md:w-1/2 px-4 py-8">
                <div className="bg-white rounded-lg p-6 shadow-md">
                  ...
                  <h4 className="mt-4 text-lg font-semibold text-blue-600">- Ananya</h4>
                </div>
              </div>
            </div>
          </div>
      ...
      <footer className="py-8 bg-black text-white text-center">
        <p>© 2024 PREP BUDDY. All rights reserved.</p>
      </footer>
    </div>
  )
}
